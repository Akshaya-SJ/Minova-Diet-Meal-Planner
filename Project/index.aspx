...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="container-fluid carouselblog-section my-5 " id="carouselblog" >
      ...
      <p class="lead text-center">"Minova provides personalized nutrition plans to help you achieve your health goals.<br> With expert guidance, we make healthy eating easy and enjoyable, empowering<br> you to live a balanced, fulfilling life."</p>
    ...
    <div id="fAQs" class="faq-container container ">
      ...
      <div class="faq-list ">
          ...
          <div class="faq-item mb-3 ">
              <div class="faq-question">
                  <h3>Can I track my progress on Minova?</h3>
                  <button class="faq-toggle">+</button>
              </div>
              <div class="faq-answer">
          ...
          <div class="faq-item mb-3 ">
              <div class="faq-question">
                  <h3>How can I get support from Minova?</h3>
                  <button class="faq-toggle">+</button>
              </div>
              <div class="faq-answer">
                  <p>You can reach our customer support team via:</p>
                  <li>Email : incuries@minova.com</li>
        ...
        <div class="owl-carousel carouseltestimonial-carousel">
          ...
          <div class="col my-5 border p-3">
            <div class="d-flex">
              ...
              <div class="ms-2">
                <p class="m-0"><strong>Jaspher</strong></p>
                <p>Developer</p>
              </div>
            </div>
            <div>
              <p class="fst-italic">"I’ve tried countless diets, but Minova was the first program that truly worked for me. Their personalized approach made all the difference. I now feel more confident in my body and my eating habits."</p>
              <div class="staricons">
          ...
          <div class="col my-5 border p-3">
            <div class="d-flex">
              ...
              <div class="ms-2">
                <p class="m-0"><strong>Ashik</strong></p>
                <p>Digital Marketing executive</p>
              </div>
            </div>
            <div>
              <p class="fst-italic">"Minova’s programs are easy to follow and full of delicious recipes. I’ve learned so much about balanced nutrition, and I love how I don’t have to sacrifice flavor to eat healthy and my eating habits!"</p>
              <div class="staricons">
                <i class="bi bi-star-fill"></i>
                <i class="bi bi-star-fill"></i>
                <i class="bi bi-star-fill"></i>
          ...
          <div class="col my-5 border p-3">
            ...
            <div>
              <p class="fst-italic">"I can't thank Minova enough for the incredible guidance and support. I’ve finally found a nutrition plan that fits my lifestyle without feeling link-underline happier, and more in control of my eating habits!"</p>
              <div class="staricons">
                <i class="bi bi-star-fill"></i>
                <i class="bi bi-star-fill"></i>
                <i class="bi bi-star-fill"></i>
